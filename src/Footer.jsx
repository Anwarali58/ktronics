            ...
            <div className="flex flex-col gap-5 mt-2">
              ...
              <div className="flex flex-wrap items-center gap-3">
                ...
                {siteSettings.twitter && (
                  <a href={siteSettings.twitter} target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full flex items-center justify-center text-white bg-black hover:opacity-80 hover:-translate-y-1 transition-all">
          ...
          <div>
            ...
            <ul className="space-y-5">
              ...
              <li className="flex items-center gap-3 text-[15px] font-bold text-slate-500">
                ...
                <span><a href={`mailto:${siteSettings.email}`} target="_blank" rel="noopener noreferrer" className="hover:text-[#45c4f0] transition-colors">{siteSettings.email}</a></span>
              </li>
            </ul>
          </div>
